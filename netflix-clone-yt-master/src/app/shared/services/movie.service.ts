...
const options = {
  ...
  headers: {
    ...
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5NDA4NjRjYjYwZTk2MWU5ZGM1YjljMGZjMjQzN2Q1MyIsInN1YiI6IjY2NTQ0MWMwNjdmNzcwYTZhNTRjYzhmNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.B99yfZeW2EMXIkpkjRpjzl1VtPsxA5kczNSsHQpuC8M'
  }
}
@Injectable({
  providedIn: 'root'
